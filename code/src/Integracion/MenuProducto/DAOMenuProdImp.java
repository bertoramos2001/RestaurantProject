...
public class DAOMenuProdImp implements DAOMenuProd {
	...
	public Collection<TProducto> leerProdsPorMenu(Integer idMenu) {
		...
		try {
			...
			while(miResult.next()){
				lista.add(new TProducto(miResult.getInt("idProducto"), miResult.getBoolean("activo"), miResult.getString("nombre")));
			}
	...
	public Collection<TMenu> leerMenusPorProd(Integer idProd) {
		...
		try {
			...
			ResultSet miResult = ps.executeQuery();
			while (miResult.next()){
				lista.add(new TMenu(miResult.getInt("idmenu"), miResult.getBoolean("activo"), miResult.getString("nombre"), miResult.getFloat("precio"), miResult.getInt("stock")));
			}
