...
public class SAFacturaImp implements SAFactura {
	...
	public Integer cerrar(Integer id) {
		...
		float precio = 0;
		ArrayList<TLineaDePedido> lineas = (ArrayList<TLineaDePedido>) FactoriaIntegracion.getInstance().generarDAOFacturaMenu().leerMenusEnFactura(id);
	...
	public Integer eliminarMenus(TLineaDePedido info){
		...
		if(linea.getCantidad() < cantidad) cantidad = linea.getCantidad();
