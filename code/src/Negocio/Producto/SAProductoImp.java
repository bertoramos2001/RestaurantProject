...
public class SAProductoImp implements SAProducto {
	...
	public int vincular(TProductoIngrediente tProdIngr) {
		...
		if (tProd != null && tProd.getActivo() && tIngr != null && tIngr.getActivo() && !daoProdIngr.contiene(tProdIngr)) {
	...
	public ArrayList<TIngrediente> mostrarIngrsPorProd(Integer idProd) {
		...
		Collection<TIngrediente> ingrsLeidos = FactoriaIntegracion.getInstance().generarDAOProdIngr().leerIngrsPorProd(idProd), 
				ingrsActivos = new ArrayList<TIngrediente>();
